...
exports.printerDetector = void 0;
...
class PrinterDetector {
    ...
    async detectWindowsPrinters() {
        try {
            ...
            let defaultPrinter = "";
            try {
                const { stdout: defOut } = await execAsync(`powershell -NoProfile -Command "(Get-CimInstance -ClassName Win32_Printer | Where-Object {$_.Default -eq $true}).Name"`, { encoding: "utf-8", timeout: 5000 });
     ...
     */
    async detectWindowsPrintersFallback() {
        try {
            const { stdout } = await execAsync("wmic printer get name,default,drivername,status /format:csv", { encoding: "utf-8", timeout: 10000 });
     ...
     */
    getPrintersByCategory(category) {
...
exports.printerDetector = new PrinterDetector();
//# sourceMappingURL=printerDetector.js.map