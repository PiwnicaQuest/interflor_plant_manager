...
exports.generateTsplLabel = generateTsplLabel;
exports.generateSimpleTsplLabel = generateSimpleTsplLabel;
exports.generateZplLabel = generateZplLabel;
exports.setDpi = setDpi;
exports.parseHtmlForTspl = parseHtmlForTspl;
...
function getBarcodeWidth(data, narrowWidth = 2) {
...
function generateTsplLabel(data, copies = 1) {
...
function generateSimpleTsplLabel(barcode, productName, width = 50, height = 30, copies = 1) {
    const labelWidth = mmToDots(width);
    const labelHeight = mmToDots(height);
    const commands = [];
    // Header
...
function generateZplLabel(barcode, productName, width = 50, height = 30, copies = 1) {
